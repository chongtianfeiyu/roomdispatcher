...
public:
	...
	void SetPartServerID(ServerID nServerID)
	{
		m_nPartServerID = nServerID;
	}

	ServerID GetPartServerID()
	{
		return m_nPartServerID;
	}
...
protected:
	void Reset()
	{
		...
		m_nPartServerID = enmInvalidServerID;
	}
...
private:
	...
	MediaRoomList						m_stMediaRoomList;					//负载的房间
	ServerID							m_nPartServerID;					//配对的mediaserver
};


FRAME_ROOMDISPATCHER_NAMESPACE_END

CCOMPLEXTYPE_SPECIFICALLY(FRAME_ROOMDISPATCHER_NAMESPACE::CMedia)
